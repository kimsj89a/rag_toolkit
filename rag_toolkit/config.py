...
Manages API, storage, and parser settings for document processing.
"""
...
DEFAULT_STORAGE_DIR = Path("./rag_storage")
DEFAULT_OUTPUT_DIR = Path("./rag_output")
...
class APIConfig:
    ...
    llm_base_url: Optional[str] = field(
        default_factory=lambda: os.getenv("RAG_LLM_BASE_URL") or None
    )
...
class StorageConfig:
    ...
    """Parsed document outputs (markdown, images)."""
